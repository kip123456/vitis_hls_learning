...
{
#line 18 "D:/code/pp4fpga/project1/fir11/solution1/csynth.tcl"
...
# 19 "fir11/fir.cpp"
 ...
 data_t tmp_ans;
 tmp_ans = 0;
 VITIS_LOOP_26_1: for(i = N-1;i>=1;i--) tmp[i] = tmp[i-1];
 tmp[0] = x;
 VITIS_LOOP_28_2: for(i = 0;i<N;i++) tmp_ans += tmp[i]*c[i];
 *y = tmp_ans;
}
